...
{
    [Fact]
    public async Task RealTableCacheFixtureSurvivesReaderImporterAndScene()
    {
        var path = Path.Combine(AppContext.BaseDirectory, "fixtures", "cad", "dxf", "table-cache-v0121.dxf");
